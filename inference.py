...
parser.add_argument("--ckpt", type=str, default="results/pretrained_checkpoints/model.pt",
...
# print(samples.shape)
save_image(samples.reshape(-1, samples.shape[-3], samples.shape[-2], samples.shape[-1]), "output.png", nrow=args.num_frames, normalize=True, value_range=(-1, 1))